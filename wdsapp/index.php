	 ...
	 <!-- Navbar d-lg-none d-xl-none-->
	  <nav class="main-header navbar navbar-expand navbar-light">
		...
		<div class="py-2 pr-3 flex-fill">
			<h1 class="m-0 text-dark bold f30">Produtos</h1>
		</div>

        <?php  if($userLevel["id"] == 1){ ?>
	  ...
	  <div class="content-wrapper">
		...
		<section class="content">
		  <div class="container-fluid">
			...
			<div class="row">
			  <div class="col-12">
				<?php echo $functions->getProducts($userLevel["id"]);?>
        ...
        <div class="modal-dialog modal-dialog-centered modal-sm" role="document">
            <div class="modal-content bg-danger">
                ...
                <div class="modal-footer">
                    <button type="button" data-dismiss="modal" class="btn btn-warning" id="confirm" onclick="delProduto($('#field_confirm').val())">Confirmar</button>
