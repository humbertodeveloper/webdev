...
<html><head>
  ...
  <title>WDS App | Adicionar Cliente</title>
...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
	...
	<h1 class="m-0 text-dark bold f30">Adicionar Cliente</h1>
    </div>
                          ...
                          <div class="col-sm-12 col-md-6 col-lg-5 col-xl-5">
                              ...
                              <div class="form-row">
                                  <div class="form-group col-sm-12 col-md-6">
                                      ...
                                      <input type="text" class="form-control documento" id="documento" name="documento" placeholder="Documento"  required>
                                  </div>
                                  <div class="form-group col-sm-12 col-md-6">
                                      <label for="telefone" aria-label="Telefone">Telefone*</label>
                                      <input type="text" class="form-control telefone" id="telefone" name="telefone" placeholder="Telefone"  required>
                                  </div>
                              </div>
                              <div class="form-row">
                              ...
                              <div class="form-row">
                                  ...
                                  <div class="form-group col-sm-12 col-md-2 col-lg-2 col-xl-2">
                                      ...
                                      <select class="custom-select " id="estado" name="estado"  required>
                                          <?php echo $functions->select_box_uf(); ?>
                                      </select>
                                  </div>
                              </div>
                              <div class="form-row">
