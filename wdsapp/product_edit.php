...
<html><head>
  ...
  <title>WDS App | Editar Produto</title>
...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
	...
	<h1 class="m-0 text-dark bold f30">Edição de Produto</h1>
    </div>
				...
				<div class="card-body">
					<div class="form-row">
						<div class="form-group col-12 ">
							<label for="user" aria-label="Usuário">Produto*</label>
							<div class="input-group">
							  <div class="input-group-prepend">
								<span class="input-group-text"><i class="fas fa-box"></i></span>
							  </div>
							  <input type="text" class="form-control " id="produto" name="produto" placeholder="Produto" value="<?php echo $produto; ?>" required>
							</div>
						</div>
					</div>
					...
					<div class="form-row">
						<div class="form-group col-6 ">
							<label for="email" aria-label="E-mail">Valor*</label>
							<div class="input-group ">
							  <div class="input-group-prepend">
								<span class="input-group-text">R$</span>
							  </div>
							  <input type="text" class="form-control input-value " id="valor" name="valor" placeholder="Valor" value="<?php echo $valor; ?>" required>
							</div>
						</div>
					</div>
