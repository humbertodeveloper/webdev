...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-light">
	...
	<h1 class="m-0 text-dark bold f30">Usuários</h1>
    </div>
	  ...
	  <div class="modal-dialog modal-dialog-centered modal-sm" role="document">
		<div class="modal-content bg-danger">
		  ...
		  <div class="modal-footer">
			<button type="button" data-dismiss="modal" class="btn btn-warning" id="confirm" onclick="delUser($('#field_confirm').val())">Confirmar</button>
