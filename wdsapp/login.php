...
$session->setSession('pagina','login');
...
<?php  if($session->getSession('id_user_WDSApp_session')){ ?>
               ...
               <div class="row">
                   <div class="col-sm-10 offset-sm-1">
                        ...
                        <div class="row text-left">
                            <div class="col-12 ">
                                <form class="form" name="login" id="login" enctype="multipart/form-data" action="javascript:authUser()">
                                    ...
                                    <div class="form-group row">
                                      ...
                                      <div class="clr"></div>
                                      <span class="f14"><a href="<?= _HOST_ ?>usuario/novasenha" class="text-danger bt">Clique aqui</a> e solicite uma nova senha.</span>
